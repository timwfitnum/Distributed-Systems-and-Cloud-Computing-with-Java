...
public class TFIDF {
    ...
    private static Map<String, Double> getTermToInverseDocumentFrequency(List<String> terms, Map<String,
    ...
    static Map<Double, List<String>> getDocumentsSortedByScore(List<String> terms,
    ...
    private static void addDocumentScoreToTreeMap(TreeMap<Double, List<String>> scoreToDoc, double score,
                                                  String document) {
